...
class DecBlock(nn.Module):
    ...
    def forward_pre(
        ...
        tgt = tgt + self.drop_path2(self.mlp(self.norm2(tgt)))
        return tgt
    ...
    def forward(
        ...
        return self.forward_pre(tgt=tgt, memory=memory, memory_mask=memory_mask, memory_key_padding_mask=memory_key_padding_mask)
